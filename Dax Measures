...
/* -------------------------------------------------------------------------
   04. CHART & AXIS FORMATTING (Ranges for Visuals)
   ------------------------------------------------------------------------- */
...
// Reconstructs Base64 Image string from partitioned table
